...
app.register_blueprint(create_testdata_routes(), url_prefix='/api/testdata')
...
logger.info("  /api/testrun - TestRun domain endpoints")
logger.info("  /api/testdata - TestData domain endpoints")
logger.info("  /api/grade - Grade domain endpoints")
