# Creators Dashboard — Evaluator API
...
## run api server in dev mode - captures command line, serves API at localhost:9096
pipenv run dev

## run E2E tests (assumes running API at localhost:9096)
pipenv run e2e
...
curl http://localhost:9096/api/config \
