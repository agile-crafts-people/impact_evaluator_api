...
LABEL org.opencontainers.image.source="https://github.com/agile-crafts-people/impact_evaluator_api"
...
CMD exec python -m gunicorn --bind 0.0.0.0:9096 src.server:app